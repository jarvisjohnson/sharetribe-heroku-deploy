...
## Now the setup:    
  ...
  9. Set up Amazon Cloudfront to deliver these assets via CDN
    ...
    - Point origin of each distribution to {your-app}.herokuapp.com // {yourdomain}

    - Edit Origin settings as per below: 

      -Images Distribution: ![cloudfront sharetribe configuration](https://github.com/jarvisjohnson/heroku-deploy-gist/images/cloudfront-sharetribe-configuration.png "cloudfront-sharetribe-configuration-images.png")

      - Uploads: ![cloudfront sharetribe configuration](https://github.com/jarvisjohnson/heroku-deploy-gist/images/cloudfront-sharetribe-configuration.png "cloudfront-sharetribe-configuration-uploads.png")
  ...
  11. Add Asset host variables to `config.yml` (in staging / production)
    ...
    ```yml
      ...
      asset_host: 'imagesDistribution.cloudfront.net'
      user_asset_host: 'uploadsDistribution.cloudfront.net'  
    ```
